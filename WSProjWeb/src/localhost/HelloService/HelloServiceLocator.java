...
public class HelloServiceLocator extends org.apache.axis.client.Service implements localhost.HelloService.HelloService {
    ...
    private java.lang.String HelloServicePort_address = "http://localhost/HelloService";
    ...
    public localhost.HelloService.HelloServicePortType getHelloServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.HelloService.HelloServiceBindingStub _stub = new localhost.HelloService.HelloServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.HelloService.HelloServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.HelloService.HelloServiceBindingStub _stub = new localhost.HelloService.HelloServiceBindingStub(new java.net.URL(HelloServicePort_address), this);
                _stub.setPortName(getHelloServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost/HelloService/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost/HelloService/", "HelloServicePort"));
        }
